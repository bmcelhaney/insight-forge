...
echo "    Commit: ${COMMIT}"
echo "    Test data API:  curl -X POST http://127.0.0.1:${PORT}/api/analyze -d '{\"nsn\":\"7920014487052\"}'"
echo "    Test insight UI: curl -X POST http://127.0.0.1:${PORT}/api/insight -d '{\"nsn\":\"7920014487052\"}'"
